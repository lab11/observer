...
uint16_t checksum(uint8_t accelx1, uint8_t accelx2, uint8_t accely1, uint8_t accely2, uint8_t accelz1, uint8_t accelz2, uint8_t light1, uint8_t light2, 
					uint8_t press1, uint8_t press2, uint8_t press3, uint8_t temp1, uint8_t temp2, uint8_t humd1, uint8_t humd2, uint8_t mic1, uint8_t mic2, uint8_t dummy){
	...
	uint16_t mic_last = mic2 << 8 | dummy;
