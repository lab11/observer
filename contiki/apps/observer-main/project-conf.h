...
/* Project configuration for the observer cape
 *
 * @author: Brad Campbell <bradjc@umich.edu>
 * 			Neal Jackson  <nealjack@umich.edu>
 *			Cynthia Kreng <krengcyn@umich.edu>
 *			Sarah Paris   <sarparis@umich.edu>
 * 			Alan Zhen	  <azhen@umich.edu>
 */
